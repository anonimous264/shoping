                        ...
                        <thead >
                            <tr>
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('custumers.create') }}" class="font-medium text-green-600 dark:text-green-500 hover:underline">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="flex items-center space-x-4 px-6 py-4">
                                    <a href="{{ route('custumers.edit', ['custumer'=>$custumer]) }}" class="mt-4 font-medium text-orange-600 dark:text-orange-500 hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" class="w-6 h-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                        </svg>
                                        {{ __('Update') }}
                                    </a>
                                    <form action="{{ route('custumers.destroy',['custumer'=>$custumer]) }}" method="post">
                                        @csrf
                                        @method('DELETE')
