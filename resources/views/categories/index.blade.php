                        ...
                        <thead >
                            <tr>
                                <th scope="col" class="px-6 py-3">
                                    <a href="{{ route('categories.create') }}" class="font-medium text-green-600 dark:text-green-500 hover:underline">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="flex items-center space-x-4 px-6 py-4">
                                    <a href="{{ route('categories.edit', ['category'=>$category]) }}" class="mt-4 font-medium text-orange-600 dark:text-orange-500 hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" class="w-6 h-6">
